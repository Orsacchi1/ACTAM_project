...
function createRichSoundSpectra() {
  ...
  const wave = C.createPeriodicWave(bands, imag, {
...
function readStuffValues() {
  ...
  sparse = document.getElementById("sparse").checked
    ? document.getElementById("sparse").value
    : 0;
  wetGain = document.getElementById("delay").checked
    ? document.getElementById("delay").value
    : 0;
  wetGainReverb = document.getElementById("reverb").checked
    ? document.getElementById("reverb").value
    : 0;
}
...
document.getElementById("changeFrequency1").onclick = () =>
